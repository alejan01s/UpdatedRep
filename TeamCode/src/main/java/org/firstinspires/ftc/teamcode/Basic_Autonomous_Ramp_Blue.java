...
@Autonomous(name = "Basic Blue Ramp Autonomous", group = "Sensor")

public class Basic_Autonomous_Ramp_Blue extends DefinerClass {
    ...
    public void runOpMode() throws InterruptedException{
        ...
        *******************
        ...
        int Angle3 = 180;
        int FinalAngle = 55;
        int NumberOfRevs1 = -850;
        int NumberOfRevs2 = -325;
