...
@Autonomous(name = "Basic Red Ramp Autonomous", group = "Sensor")

public class Basic_Autonomous_Ramp_Red extends DefinerClass {
        ...
        *******************
        ...
        while(opModeIsActive()){
            ...
            if(step == 4.1){
                ...
                FL.setPower(0);
                BL.setPower(0);
                NumberOfRevsFinal = FR.getCurrentPosition() + 165;
                step = step + 1;
            }
            if(step == 5.1){
