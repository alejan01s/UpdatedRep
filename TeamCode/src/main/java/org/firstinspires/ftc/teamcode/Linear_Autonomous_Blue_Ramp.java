...
@Autonomous(name = "Blue Ramp Autonomous", group = "Sensors")
public class Linear_Autonomous_Blue_Ramp extends LinearOpMode{
...
//                        FL.setPower(0);
            ...
            if(step == 17){
                turnCompleted = false;
                NumberOfRevs3 = FL.getCurrentPosition() + 7900;
                step=step+1;
            }
            if(step == 18){
                if(FL.getCurrentPosition() < NumberOfRevs3) {
