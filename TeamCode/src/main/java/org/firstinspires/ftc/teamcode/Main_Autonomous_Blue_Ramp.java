...
//                }
        ...
        //set possible rev3
        if(step == 7){
            NumberOfRevs4 = FL.getCurrentPosition() - 85;
...
//                }
        ...
        if(step == 11.5){
            while(RightDistanceTime > 1150 || RightDistanceTime == 0) {
                CollectDistanceTime = true;

                //Reading the Sonar Sensors
                if(RightDistanceTime < 1150 && !(RightDistanceTime == 0)){
                    break;
                }
                //Reading Distance in MicroSeconds
                if (CollectDistanceTime == true)//Once the CollectDistanceTime boolean is switched on, the robot takes a snapshot of the distance in MicroSeconds
...
//
            ...
            if (sleepOn) {
                ...
                while (System.currentTimeMillis() < timeToWake) {
                    if(System.currentTimeMillis() > timeToWake){
                        break;
                    }
                }
        ...
        if(step == 15.75){
            NumberOfRevs3 = FL.getCurrentPosition() + 5750;
            if(OppPushSequence){
                NumberOfRevs3 = FL.getCurrentPosition() + 6250;
            }
            step = step + .25;
        }
        ...
        if(step == 16){
            ...
            if(FL.getCurrentPosition() < NumberOfRevs3 - 800)
            {
...
//            }
        ...
        if(Push5 && Ignore == false)
        {
            ...
            Push5Complete = false;
            PusherSleep = System.currentTimeMillis() + 400;
            buttonPusher2.setPosition(0.6);
            Push5Go = true;
            Push5 = false;
